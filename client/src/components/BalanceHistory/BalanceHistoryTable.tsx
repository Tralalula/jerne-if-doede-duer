...
import BalanceHistoryTableHeader from './BalanceHistoryTableHeader';
...
export default function BalanceHistoryTable({ entries, showUserEmail = false }: BalanceHistoryTableProps) {
    ...
    return (
        <Table.Root variant="surface">
            <Table.Header>
                <Table.Row>
                    <BalanceHistoryTableHeader>Dato</BalanceHistoryTableHeader>
                    {showUserEmail && (
