...
import { SortOrder, GameHistorySortAtom } from '../import';

interface SortableColumnHeaderProps {
    children: React.ReactNode;
}

export default function GameBoardHistoryTableHeader({ children }: SortableColumnHeaderProps) {
    const [sort, setSort] = useAtom(GameHistorySortAtom);
