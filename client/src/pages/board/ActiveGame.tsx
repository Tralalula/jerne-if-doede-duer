import { Badge, Button, Flex, Grid, Heading, Separator, Skeleton, Text, TextField } from "@radix-ui/themes";
import { GameButton, ResizablePanel, LoadingButton } from "../../components";
import { Fragment, useEffect, useState } from "react";
import { useToast } from "../../hooks";
import { SubmitHandler, useForm } from "react-hook-form";
import { BoardPickRequest, BoardPickResponse } from "../../Api";
...
interface ActiveGameProps {
    ...
    placeBoardPick: (data: BoardPickRequest) => Promise<BoardPickResponse>;
    isPlacingBoardPick: boolean;
    loading: boolean;
}
